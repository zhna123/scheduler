...
import { setOffSchedule } from "@/app/lib/actions";
import { Device } from "@/app/lib/data-utils";
import Link from "next/link";
import { TimePicker } from "../components/TimePicker";

export default function OffForm({device, location}: {device: Device, location: string}) {

  return (
    <form action={setOffSchedule} className="text-sch_gray-800 w-[350px] flex flex-col h-full">
