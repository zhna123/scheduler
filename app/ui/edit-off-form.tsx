...
import { editOffSchedule } from "../lib/actions";

export default function EditOffForm({device, location}: {device: Device, location: string}) {
  return (
    <form action={editOffSchedule} className="text-sch_gray-800 w-[350px] flex flex-col h-full">
      ...
      <label className="flex items-center justify-between mb-10">
        Turn Off
        <TimePicker id="offTimePicker" time={device.off_time} />
      </label>
